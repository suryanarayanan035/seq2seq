...
class DecoderPrenetWrapper(tf.compat.v1.nn.rnn_cell.RNNCell):
...
class OutputProjectionWrapper(tf.compat.v1.nn.rnn_cell.RNNCell):
    def __init__(self, cell, linear_projection_size):
        ...
        self.out_projection_layer = tf.keras.layers.Dense(units=linear_projection_size, activation="relu", name="output_projection")
